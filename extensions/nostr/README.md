...
Nostr DM channel plugin for Logica using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Logica. It enables your bot to:
...
# Configure logica to use local relay
