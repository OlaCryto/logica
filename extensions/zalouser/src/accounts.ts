...
export function listZalouserAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: LogicaConfig): string {
...
function mergeZalouserAccountConfig(cfg: LogicaConfig, accountId: string): ZalouserAccountConfig {
