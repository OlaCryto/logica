...
export function listBlueBubblesAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: LogicaConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: LogicaConfig): ResolvedBlueBubblesAccount[] {
