...
This directory contains the **BlueBubbles external channel plugin** for Logica.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `logica/plugin-sdk` helpers.
