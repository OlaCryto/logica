...
import type { ReplyPayload, LogicaConfig } from "logica/plugin-sdk";
import { createReplyPrefixOptions } from "logica/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as LogicaConfig;
