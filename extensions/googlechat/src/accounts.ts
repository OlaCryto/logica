...
export function listGoogleChatAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: LogicaConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: LogicaConfig): ResolvedGoogleChatAccount[] {
