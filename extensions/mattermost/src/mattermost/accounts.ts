...
export function listMattermostAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: LogicaConfig): string {
...
export function listEnabledMattermostAccounts(cfg: LogicaConfig): ResolvedMattermostAccount[] {
