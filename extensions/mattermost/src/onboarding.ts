import type { ChannelOnboardingAdapter, LogicaConfig, WizardPrompter } from "logica/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.logica.ai/channels/mattermost",
    ].join("\n"),
