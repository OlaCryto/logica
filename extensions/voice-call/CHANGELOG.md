...
- Version alignment with core Logica release numbers.
...
- First public release of the @logica/voice-call plugin.
...
- CLI: `logica voicecall` commands (call/start/continue/speak/end/status/tail/expose).
