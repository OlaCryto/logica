...
show_usage() {
    cat << EOF
clawlog - Logica Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Logica logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Logica logs flow through the macOS unified log (subsystem: ai.logica).
