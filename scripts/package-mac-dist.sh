...
# Output:
# - dist/Logica.app
# - dist/Logica-<version>.zip
# - dist/Logica-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Logica-$VERSION.zip"
DMG="$ROOT_DIR/dist/Logica-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Logica-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Logica-$VERSION.dSYM.zip"
