...
- **GitHub:** https://github.com/logica/logica
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@logica](https://x.com/logica)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/logica/logica/discussions) or ask in Discord first
3. **Questions** → Discord #setup-help

## Before You PR

- Test locally with your Logica instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for Logica skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/logica/logica/issues) for "good first issue" labels!
