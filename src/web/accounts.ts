...
function listConfiguredAccountIds(cfg: LogicaConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: LogicaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: LogicaConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: LogicaConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: LogicaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: LogicaConfig): ResolvedWhatsAppAccount[] {
