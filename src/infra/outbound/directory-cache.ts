...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: LogicaConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: LogicaConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: LogicaConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: LogicaConfig): void {
