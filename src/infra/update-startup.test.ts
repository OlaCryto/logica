...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "logica-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveLogicaPackageRoot } = await import("./logica-root.js");
    ...
    vi.mocked(resolveLogicaPackageRoot).mockResolvedValue("/opt/logica");
