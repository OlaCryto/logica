...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof LogicaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: LogicaConfig; env: NodeJS.ProcessEnv }): {
  cfg: LogicaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
