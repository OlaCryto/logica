...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@logica", { botUsername: "logica" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@logica args", {
        botUsername: "logica",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "logica" })).toBe(
      "/help@otherbot",
    );
  });
