...
export const A2UI_PATH = "/__logica__/a2ui";

export const CANVAS_HOST_PATH = "/__logica__/canvas";

export const CANVAS_WS_PATH = "/__logica__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.logicaCanvasA2UIAction.postMessage(...)
  // - Android: window.logicaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["logicaCanvasA2UIAction"];
  ...
  globalThis.Logica = globalThis.Logica ?? {};
  globalThis.Logica.postMessage = postToNode;
  globalThis.Logica.sendUserAction = sendUserAction;
  globalThis.logicaPostMessage = postToNode;
  globalThis.logicaSendUserAction = sendUserAction;
