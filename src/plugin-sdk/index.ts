...
export type { LogicaConfig } from "../config/config.js";
/** @deprecated Use LogicaConfig instead */
export type { LogicaConfig as ClawdbotConfig } from "../config/config.js";
