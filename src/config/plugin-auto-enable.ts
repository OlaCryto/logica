import type { LogicaConfig } from "./config.js";
...
function isTelegramConfigured(cfg: LogicaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: LogicaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: LogicaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: LogicaConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: LogicaConfig): boolean {
...
function isIMessageConfigured(cfg: LogicaConfig): boolean {
...
function isWhatsAppConfigured(cfg: LogicaConfig): boolean {
...
function isGenericChannelConfigured(cfg: LogicaConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: LogicaConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: LogicaConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: LogicaConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: LogicaConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: LogicaConfig, pluginId: string): LogicaConfig {
...
function registerPluginEntry(cfg: LogicaConfig, pluginId: string): LogicaConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
