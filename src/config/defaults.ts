...
function resolveAnthropicDefaultAuthMode(cfg: LogicaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: LogicaConfig): LogicaConfig {
...
export function applyTalkApiKey(config: LogicaConfig): LogicaConfig {
...
export function applyModelDefaults(cfg: LogicaConfig): LogicaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: LogicaConfig): LogicaConfig {
...
export function applyLoggingDefaults(cfg: LogicaConfig): LogicaConfig {
...
export function applyContextPruningDefaults(cfg: LogicaConfig): LogicaConfig {
...
export function applyCompactionDefaults(cfg: LogicaConfig): LogicaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
