...
function resolveWatchPaths(workspaceDir: string, config?: LogicaConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: LogicaConfig }) {
