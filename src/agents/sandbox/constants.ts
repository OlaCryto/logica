...
export const DEFAULT_SANDBOX_IMAGE = "logica-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "logica-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "logica-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "logica-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "logica-sbx-browser-";
