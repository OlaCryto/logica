  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "logica.sandbox=1",
        "--label",
        "logica.sessionKey=main",
        "--label",
        "logica.createdAtMs=1700000000000",
        "--label",
        "logica.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
