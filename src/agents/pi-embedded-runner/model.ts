...
// pi-ai's built-in Anthropic catalog can lag behind Logica's defaults/docs.
...
export function buildModelAliasLines(cfg?: LogicaConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveLogicaAgentDir();
