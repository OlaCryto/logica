...
describe("createLogicaCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createLogicaCodingTools({
      config,
    ...
    const anthropicTools = createLogicaCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createLogicaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createLogicaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
