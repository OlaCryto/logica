...
function resolveAvatarSource(cfg: LogicaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: LogicaConfig, agentId: string): AgentAvatarResolution {
