...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.LOGICA_STATE_DIR;
  const configPath = env.LOGICA_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    LOGICA_PROFILE: profile,
    LOGICA_STATE_DIR: stateDir,
    LOGICA_CONFIG_PATH: configPath,
    LOGICA_GATEWAY_PORT: String(port),
    LOGICA_GATEWAY_TOKEN: token,
    LOGICA_LAUNCHD_LABEL: resolvedLaunchdLabel,
    LOGICA_SYSTEMD_UNIT: systemdUnit,
    LOGICA_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    LOGICA_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    LOGICA_STATE_DIR: stateDir,
    LOGICA_CONFIG_PATH: configPath,
    LOGICA_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    LOGICA_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    LOGICA_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    LOGICA_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    LOGICA_LOG_PREFIX: "node",
    LOGICA_SERVICE_MARKER: NODE_SERVICE_MARKER,
    LOGICA_SERVICE_KIND: NODE_SERVICE_KIND,
    LOGICA_SERVICE_VERSION: VERSION,
  };
}
