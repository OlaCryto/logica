...
import { type LogicaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: LogicaConfig): string[] {
...
export function listAgentsForGateway(cfg: LogicaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: LogicaConfig): string {
...
function resolveSessionStoreAgentId(cfg: LogicaConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: LogicaConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: LogicaConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: LogicaConfig): GatewaySessionsDefaults {
