...
export type ChannelAgentToolFactory = (params: { cfg?: LogicaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: LogicaConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: LogicaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: LogicaConfig }) => boolean;
  supportsCards?: (params: { cfg: LogicaConfig }) => boolean;
