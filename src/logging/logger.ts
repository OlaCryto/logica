...
export const DEFAULT_LOG_DIR = "/tmp/logica";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "logica.log"); // legacy single-file path

const LOG_PREFIX = "logica";
