...
export function listIMessageAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: LogicaConfig): string {
...
function mergeIMessageAccountConfig(cfg: LogicaConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: LogicaConfig): ResolvedIMessageAccount[] {
