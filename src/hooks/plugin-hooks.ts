...
import type { LogicaPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: LogicaPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: LogicaPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
