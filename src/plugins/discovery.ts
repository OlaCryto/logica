...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @logica/voice-call -> voice-call).
...
export function discoverLogicaPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".logica", "extensions")];
