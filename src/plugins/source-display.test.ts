...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/logica/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/logica/extensions",
        global: "/Users/x/.logica/extensions",
        workspace: "/Users/x/ws/.logica/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.logica/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/logica/extensions",
        global: "/Users/x/.logica/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.logica/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/logica/extensions",
        global: "/Users/x/.logica/extensions",
