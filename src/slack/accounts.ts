...
export function listSlackAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: LogicaConfig): string {
...
function mergeSlackAccountConfig(cfg: LogicaConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: LogicaConfig): ResolvedSlackAccount[] {
