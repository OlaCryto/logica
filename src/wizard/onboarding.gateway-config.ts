...
import type { GatewayBindMode, GatewayTailscaleMode, LogicaConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.logica.ai/gateway/tailscale", "https://docs.logica.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
