...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.LOGICA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: LogicaConfig): string {
...
function mergeTelegramAccountConfig(cfg: LogicaConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: LogicaConfig): ResolvedTelegramAccount[] {
