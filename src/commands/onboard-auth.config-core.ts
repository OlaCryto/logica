...
export function applyZaiConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applyOpenrouterProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applyOpenrouterConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applyMoonshotProviderConfig(cfg: LogicaConfig): LogicaConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: LogicaConfig): LogicaConfig {
...
export function applyMoonshotConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applyMoonshotConfigCn(cfg: LogicaConfig): LogicaConfig {
...
export function applyKimiCodeProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applySyntheticProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applyXiaomiProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: LogicaConfig): LogicaConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: LogicaConfig): LogicaConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applyXaiProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: LogicaConfig): LogicaConfig {
...
export function applyQianfanProviderConfig(cfg: LogicaConfig): LogicaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: LogicaConfig): LogicaConfig {
