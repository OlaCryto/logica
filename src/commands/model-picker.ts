...
function resolveConfiguredModelRaw(cfg: LogicaConfig): string {
...
function resolveConfiguredModelKeys(cfg: LogicaConfig): string[] {
...
export function applyPrimaryModel(cfg: LogicaConfig, model: string): LogicaConfig {
...
export function applyModelAllowlist(cfg: LogicaConfig, models: string[]): LogicaConfig {
  const defaults = cfg.agents?.defaults;
