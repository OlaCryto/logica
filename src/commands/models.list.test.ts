...
const ensureLogicaModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveLogicaAgentDir = vi.fn().mockReturnValue("/tmp/logica-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/logica-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureLogicaModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveLogicaAgentDir,
}));
