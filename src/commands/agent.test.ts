...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "logica-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<LogicaConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<LogicaConfig["telegram"]>>,
