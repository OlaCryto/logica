...
function resolveDefaultAccountId(cfg: LogicaConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: LogicaConfig): boolean {
...
export function summarizeBindings(cfg: LogicaConfig, bindings: AgentBinding[]): string[] {
