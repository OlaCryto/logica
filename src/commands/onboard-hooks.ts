...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.logica.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("logica hooks list")}`,
      `  ${formatCliCommand("logica hooks enable <name>")}`,
      `  ${formatCliCommand("logica hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
