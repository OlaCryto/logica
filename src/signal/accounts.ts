...
export function listSignalAccountIds(cfg: LogicaConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: LogicaConfig): string {
...
function mergeSignalAccountConfig(cfg: LogicaConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: LogicaConfig): ResolvedSignalAccount[] {
