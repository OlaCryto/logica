...
- Install via CLI: `logica plugins install @logica/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `logica plugins install ./extensions/zalo`
   - From npm (if published): `logica plugins install @logica/zalo`
...
- Approve via:
  - `logica pairing list zalo`
  - `logica pairing approve zalo <CODE>`
...
- Example: `logica message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `logica channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `logica logs --follow`
