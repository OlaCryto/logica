...
Logica treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Logica “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Logica can see that group and respond there.
...
Translation: allowlisted senders can trigger Logica by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@logica", "logica", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
