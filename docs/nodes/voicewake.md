...
Logica treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.logica/settings/voicewake.json`

Shape:

```json
{ "triggers": ["logica", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
