...
Logica has two separate “streaming” layers:
...
When block streaming is enabled, Logica can **merge consecutive block chunks**
...
When draft streaming is active, Logica disables block streaming for that reply to avoid double-streaming.
