...
本指南总结了在 Logica 中开发 Pi 集成的合理工作流程。
...
状态存储在 Logica 状态目录下。默认为 `~/.logica`。如果设置了 `LOGICA_STATE_DIR`，则使用该目录。
...
- https://docs.logica.ai/testing
- https://docs.logica.ai/start/getting-started
