...
This guide summarizes a sane workflow for working on the pi integration in Logica.
...
- Trigger the agent directly:
  - `pnpm logica agent --message "Hello" --thinking low`
...
State lives under the Logica state directory. Default is `~/.logica`. If `LOGICA_STATE_DIR` is set, use that directory instead.

To reset everything:

- `logica.json` for config
...
- [https://docs.logica.ai/testing](https://docs.logica.ai/testing)
- [https://docs.logica.ai/start/getting-started](https://docs.logica.ai/start/getting-started)
