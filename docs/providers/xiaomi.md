---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Logica"
read_when:
  - You want Xiaomi MiMo models in Logica
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Logica uses
