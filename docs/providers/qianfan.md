---
summary: "Use Qianfan's unified API to access many models in Logica"
read_when:
...
3. Logica installed on your system
...
4. Copy the API key for use with Logica

## CLI setup

```bash
logica onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Logica Configuration](/gateway/configuration)
