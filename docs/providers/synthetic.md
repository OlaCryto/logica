---
summary: "Use Synthetic's Anthropic-compatible API in Logica"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Logica registers it as the
...
Note: Logica's Anthropic client appends `/v1` to the base URL, so use
