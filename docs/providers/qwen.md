---
summary: "Use Qwen OAuth (free tier) in Logica"
read_when:
  - You want to use Qwen with Logica
...
If you already logged in with the Qwen Code CLI, Logica will sync credentials
