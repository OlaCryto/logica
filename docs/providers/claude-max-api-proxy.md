...
You can point Logica at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Logica
...
- [Anthropic provider](/providers/anthropic) - Native Logica integration with Claude setup-token or API keys
