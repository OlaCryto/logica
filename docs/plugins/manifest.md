...
read_when:
  - You are building a Logica plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (logica.plugin.json)

Every plugin **must** ship a `logica.plugin.json` file in the **plugin root**.
Logica uses this manifest to validate configuration **without executing plugin
