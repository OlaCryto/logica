---
summary: "Overview of Logica onboarding options and flows"
read_when:
...
Logica supports multiple onboarding paths depending on where the Gateway runs
...
- [`logica onboard` command](/cli/onboard)

## macOS app onboarding

Use the Logica app when you want a fully guided setup on macOS. Docs:
