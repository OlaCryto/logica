---
summary: "First-run onboarding flow for Logica (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Logica">
...
<Step title="CLI">
  ...
  The app can install the global `logica` CLI via npm/pnpm so terminal
