...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.logica", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Logica windows, but below the system’s pop-up menus.
