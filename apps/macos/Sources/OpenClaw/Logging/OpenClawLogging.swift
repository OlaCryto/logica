...
enum LogicaLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = LogicaOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = LogicaFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        LogicaLogging.bootstrapIfNeeded()
        let label = LogicaLogging.makeLabel(subsystem: subsystem, category: category)
...
struct LogicaOSLogHandler: LogHandler {
...
struct LogicaFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = LogicaLogging.parseLabel(self.label)
