...
enum UIStrings {
    static let welcomeTitle = "Welcome to Logica"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: LogicaOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: LogicaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g logica@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: LogicaChatViewModel(
