...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .logicaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? LogicaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? LogicaPaths.stateDirURL.path
...
extension Notification.Name {
    static let logicaSelectSettingsTab = Notification.Name("logicaSelectSettingsTab")
}
