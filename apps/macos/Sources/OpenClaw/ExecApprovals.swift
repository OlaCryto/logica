...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.logica", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        LogicaPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        LogicaPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
