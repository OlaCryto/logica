...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = LogicaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = LogicaConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = LogicaConfigFile.loadDict()
            ...
            LogicaConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/logica"
        state.remoteCliPath = ""
        return state
    }
}
