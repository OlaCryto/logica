...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.logica", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Logica/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__logica__/a2ui/").absoluteString + "?platform=macos"
    }
