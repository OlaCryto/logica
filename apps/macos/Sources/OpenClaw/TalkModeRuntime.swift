...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.logica", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.logica", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [LogicaChatMessage] = messages.compactMap { item in
