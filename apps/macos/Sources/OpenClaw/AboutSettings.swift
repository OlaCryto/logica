...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/logica/logica") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/logica/logica")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://logica.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "LogicaBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "LogicaBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "LogicaGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LogicaGitCommit") as? String) ??
            "unknown"
    }
