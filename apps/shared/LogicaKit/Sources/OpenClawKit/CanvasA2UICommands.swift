...
public enum LogicaCanvasA2UICommand: String, Codable, Sendable {
...
public struct LogicaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct LogicaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
