...
@MainActor
public struct LogicaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: LogicaChatViewModel
    ...
    private var visibleMessages: [LogicaChatMessage] {
        let base: [LogicaChatMessage]
    ...
    private func mergeToolResults(in messages: [LogicaChatMessage]) -> [LogicaChatMessage] {
    ...
    private func isToolResultMessage(_ message: LogicaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: LogicaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: LogicaChatMessage) -> String {
