...
public typealias LogicaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias LogicaPlatformImage = UIImage
#endif

public struct LogicaChatUsageCost: Codable, Hashable, Sendable {
...
public struct LogicaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: LogicaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(LogicaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct LogicaChatMessageContent: Codable, Hashable, Sendable {
...
public struct LogicaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [LogicaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: LogicaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [LogicaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: LogicaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(LogicaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([LogicaChatMessageContent].self, forKey: .content) {
...
public struct LogicaChatHistoryPayload: Codable, Sendable {
...
public struct LogicaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct LogicaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [LogicaSessionPreviewItem]
}

public struct LogicaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [LogicaSessionPreviewEntry]

    public init(ts: Int, previews: [LogicaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct LogicaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct LogicaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct LogicaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct LogicaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct LogicaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct LogicaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: LogicaPlatformImage?
...
public struct LogicaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
