...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.logica", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.logica", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: LogicaProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
