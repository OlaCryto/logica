...
public enum LogicaTalkCommand: String, Codable, Sendable {
...
public struct LogicaTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct LogicaTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
