...
final class ScreenController {
    ...
    /// Callback invoked when an logica:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = LogicaKitResources.bundle
...
/// Handles navigation policy to intercept logica:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept logica:// deep links.
        if url.scheme?.lowercased() == "logica" {
