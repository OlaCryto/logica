...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: LogicaPhotosLatestParams) async throws -> LogicaPhotosLatestPayload {
        ...
        var results: [LogicaPhotoPayload] = []
        ...
        return LogicaPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> LogicaPhotoPayload
    {
