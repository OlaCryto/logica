...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = LogicaLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = LogicaLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.logica.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(LogicaLocationMode.off.rawValue)
                            Text("While Using").tag(LogicaLocationMode.whileUsing.rawValue)
                            Text("Always").tag(LogicaLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while Logica is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = LogicaLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: LogicaLocationMode {
        LogicaLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
