## Logica Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_logica-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm logica gateway --port 18789 --verbose
```
